# 상속
# 1. 상속이란?
# 어떤 클래스가 가지고 있는 기능을 그대로 물려받아서 사용할 수 있는 클래스를 만들 수 있음
...
# 2. 상속 관계 규현
# 기본적으로 두 클래스가 상속 관계에 놓이려면 IS-A 관계가 성립해야 함
...
# is-a 관계는 '직원은 사람이다 employee is-a person' 또는 '자동차는 차량이다 car is-a vehicle'이라고 부른다.
